...
public class LunasFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.lunas_fragment, container, false);
    ...
    private void getData() {
        stringRequest = new StringRequest(Request.Method.POST, URL_BILLING_LUNAS, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    for (int a = 0; a < jsonArray.length(); a++) {
                        ...
                        if (modelMenu.getStatus_bayar().equals("1")){
                            modelMenu.setStatus_bayar("Telah Di Proses");
                        }
